...
class GetCT(Dataset):
    ...
    def __getitem__(self,index):
        ...
        phase_path = self.data_names[index].replace('tran_all/amp/', 'tran_all/phase/', 1)
        phase = loadmat(phase_path)['data']
        # amp_cut = np.ones((size, size), np.float32)
        # phase_cut = np.ones((size, size), np.float32)
...
def get_dataset(config, uniform_dequantization=False, evaluation=False):
  ...
  # dataset = GetCT(root= "./train_data")
  # test_dataset = GetCT(root= "./train_data")
  # /home/lqg/ZL/HOLOGRAM/holo_dataset/all
  dataset = GetCT(root= "/code/HOLOGRAM/holo_dataset/all/train_all/amp")
  test_dataset = GetCT(root= "/code/HOLOGRAM/holo_dataset/all/train_all/amp")

  dataset = GetCT(root= "/code/HOLOGRAM/holo_dataset/seven/train_seven/amp")
  test_dataset = GetCT(root= "/code/HOLOGRAM/holo_dataset/seven/train_seven/amp")
